...
\pageheader{Unit 1, Lesson 1.3}{Experience \& Formalize: Twenty-Four Finishing Times}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=6pt]
  \item The row marked \textbf{3} stands for the times 34, 35, 36, 36, 38, and 39.
        ...
        How many students finished in total? \blank{2.0cm} \quad
        Fastest time: \blank{1.8cm} \quad Slowest: \blank{1.8cm}
  ...
  \item Group the 24 times into five-minute blocks by counting them off the plot above.
        ...
        \hline
        \textbf{Students} & \blank{1.0cm} & \blank{1.0cm} & \blank{1.0cm} & \blank{1.0cm} &
...
\normalsize
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=6pt]
  \item Add up the bar heights in each picture. Left: \blank{1.8cm} \quad
        Right: \blank{1.8cm} \quad Should they match? \blank{2.0cm}
...
\begin{itemize}[leftmargin=1.1em, itemsep=4pt]
  \item A \textbf{discrete} variable takes a \blank{2.2cm} number of values (siblings,
        questions attempted). A \textbf{continuous} variable can take \blank{2.6cm} many ---
  ...
  \item \textbf{Dotplot:} one dot per observation, stacked. \textbf{Stemplot:} each value split
        into a \blank{1.6cm} (leading digits) and a \blank{1.6cm} (last digit). Both keep
        \blank{2.6cm} individual value.
  \item \textbf{Histogram:} the height of each bar is the number of observations falling in
        that \blank{2.0cm}. Individual values are \blank{1.8cm}.
  \item \textbf{Bars touch} in a histogram, because the horizontal axis is a
        \blank{2.4cm}. (In a bar graph the categories were separate, so those bars had gaps.)
  \item \textbf{Changing the interval width changes the \blank{2.4cm} of the histogram} ---
        without changing a single data value. Too wide hides features; too narrow shows noise.
  \item A \textbf{cumulative graph} shows how many observations are \blank{3.0cm} a given value.
\end{itemize}
\end{tcolorbox}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=6pt]
  \item How many riders are shown? \blank{2.0cm} \quad How many waited more than 8 minutes?
        \blank{2.0cm}
  \item Is waiting time discrete or continuous? \blank{2.6cm} \quad Explain how you can tell

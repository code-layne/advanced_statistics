...
together}, \textbf{you do the rest on your own}. The notes give you the vocabulary, the three
displays, and what happens when the interval width changes; the last practice set is where you
run it by yourself. \textbf{Two of the pictures in this packet are both correct and disagree
with each other} --- when that happens, do not pick a favourite. Work out what was changed.
\end{remindbox}

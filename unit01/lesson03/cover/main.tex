...
2 & Guided Notes \& Practice & Two kinds of quantitative variable, three ways to draw one, and
                 the same 24 finishing times telling two different stories & \blank{1.2cm} \\
...
4 & Homework & Discrete vs.\ continuous, two histograms of one data set, a stem plot, and
                 one multiple-choice item --- \textbf{scored, due the first class after two study halls} & \blank{1.2cm} \\
\midrule
...
\begin{remindbox}
\small
The same 24 finishing times are drawn twice in these notes, and the two histograms tell two
different stories. \textbf{Both are correct.} When two pictures of one data set disagree, do not
pick a favourite --- work out what was changed, because a histogram shows you the data \emph{and}
a choice somebody made about it. And a value written as a whole number is not automatically a
count: ask whether the thing was \textbf{counted} or \textbf{measured}, not how it was written
down.
\end{remindbox}

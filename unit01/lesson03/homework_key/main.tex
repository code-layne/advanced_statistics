...
% replaces this page and strikes its score cell on the cover. Started in the last four minutes
...
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  ...
  \item \textbf{AP-style multiple choice.} A researcher has 200 reaction times measured to the nearest
        ...
        \end{enumerate}
        \answerspace{2.4cm}{(B). A stem plot of 200 continuous values would be unreadable, and

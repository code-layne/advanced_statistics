...
\begin{enumerate}[leftmargin=1.7em, itemsep=0.19in]
  ...
  \item Which of these could sensibly come out to \textbf{7.5}? \textbf{Circle} every one
        ...
        \ansline{B and D are measured, so a value can fall anywhere between two others.}\\[1pt]\ansline{A and C are counted --- you get whole numbers and nothing in between.}

...
\small
\vocabterm{Frequency}
\vocabterm{Relative frequency}
\vocabterm{Frequency table}
\vocabterm{Relative frequency table}
\vocabterm{Distribution (of a categorical variable)}
\end{vocabbox}
...
\vspace{6pt}
A survey of 25 Statistics students asks: ``How do you get to school?''

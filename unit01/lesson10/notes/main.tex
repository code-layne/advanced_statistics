...
\small
\begin{multicols}{2}
\vocabterm{Normal distribution}
\vocabterm{68--95--99.7 Rule (Empirical Rule)}
\vocabterm{$z$-score (standardized value)}
\columnbreak
\vocabterm{Standard Normal distribution $N(0,1)$}
\vocabterm{Normal table (Table A)}
\vocabterm{Normal probability plot (NPP)}
\end{multicols}
\end{vocabbox}

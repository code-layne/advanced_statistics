...
\begin{enumerate}[leftmargin=1.9em, itemsep=5pt]
  ...
  \item A student looked at \textbf{Display B} and wrote: \emph{``This distribution is skewed to
        ...
        side the \emph{tail} runs out on, not the side the pile sits on. Here the values bunch
        at the low end and a few stragglers stretch far out to the high end, so the long tail is
        the right one. The student named the picture by where the data \emph{is}.}

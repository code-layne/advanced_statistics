...
\begin{enumerate}[leftmargin=1.9em, itemsep=0.11in]
  ...
  \item Which conclusion is \textbf{supported} by this display?
        \begin{enumerate}[label=\textbf{(\Alph*)}, leftmargin=2.2em, itemsep=2pt]
          ...
          \item \ans{Most of these 40 employees commute under 30 minutes; one commutes over 80.}
...
\begin{enumerate}[leftmargin=1.9em, itemsep=0.12in, resume]
  ...
  \item Use the commute record above.
        ...
        in context.\\[4pt]
        \ansline{Skewed right: most of these 40 employees commute under 30 minutes, with a tail of}\\[1pt]
        ...
        \ansline{It leaves out shape, spread, and the unusual value: these commutes run from under}\\[1pt]
        ...
        \ansline{That employee lands in a 60--90 interval with the two 50--60 commutes, so the long}\\[1pt]
        \ansline{commute stops standing apart --- the width changes the picture, not the data.}

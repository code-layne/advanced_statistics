...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Center \& Variability $\cdot$ problems 1--6}
  \vspace{4pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Peaks \& Mirror $\cdot$ three pictures, three stories $\cdot$ problems 7--10}
  \vspace{6pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Unusual Features $\cdot$ outliers, gaps, clusters $\cdot$ problems 11--14}
  \vspace{4pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, The Tail $\cdot$ the whole point of today $\cdot$ problems 15--16}
  \vspace{6pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, The Tail $\cdot$ problems 17--19, the counterweights --- do not skip these}
  \vspace{8pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{5pt}
    \item \textbf{21.} Which way does it lean? Point at the tail, then name it.
    \item \textbf{22.} How many students? How many peaks? Which value sits apart, and where
          does the gap run?
    \item \textbf{23.} What does that longer tail mean \emph{for these students}?
    \item \textbf{24.} Now say all four: shape, unusual features, center, spread. In context.
  \end{itemize}

...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes section 1 $\cdot$ center and variability}
  \vspace{4pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes section 1 $\cdot$ three pictures, three stories}
  \vspace{6pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes section 2 $\cdot$ outliers, gaps, clusters}
  \vspace{4pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{the counterweights --- do not skip these}
  \vspace{8pt}
  \begin{columns}[t]

...
\small
\begin{multicols}{2}
\vocabterm{Parallel (side-by-side) boxplots}
\vocabterm{Back-to-back stemplot}
\vocabterm{Comparative statement}
\columnbreak
\vocabterm{Overlapping distributions}
\vocabterm{Explicit comparative language}
\vocabterm{Context (in a comparison)}
\end{multicols}
\end{vocabbox}

...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Counts \& Shares $\cdot$ problem 3}
  \vspace{10pt}
  \begin{center}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, About Half $\cdot$ the plurality trap, problem 4}
  \vspace{8pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Wins First $\cdot$ the crux, problem 12}
  \vspace{4pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Wins First $\cdot$ the counterweight, problem 14}
  \vspace{10pt}
  \begin{columns}[t]
    \begin{column}{0.46\textwidth}

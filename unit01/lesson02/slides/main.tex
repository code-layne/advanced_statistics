...
\begin{frame}[t, plain]
  ...
  \begin{minipage}{0.9\textwidth}
    ...
    \begin{enumerate}
      ...
      \item Look at the variables in the data table on your warm-up sheet.
            Which ones record words or labels rather than numbers?
      \item You are given the average value for one of the numeric variables.
            Is that average a fair, useful summary of the group?
      \item You are given the average of a 1--5 rating scale.
            Does averaging a scale like that actually tell you anything meaningful?
      \item Sort all four variables into the two-column table at the bottom
            of your warm-up sheet.
    \end{enumerate}

    \vspace{0.6cm}
    {\color{navy}\itshape\small
      Be ready to share your reasoning for questions 2 and 3 --- there is
...
\begin{frame}[t, plain]
  ...
  \begin{minipage}{0.93\textwidth}
    ...
    \begin{tabular}{@{} >{\bfseries\leavevmode\color{navy}}p{0.20\textwidth}
                        p{0.30\textwidth}
                        p{0.38\textwidth} @{}}
      \rowcolor{sky}
      Variable & Why it looks quantitative & Why it is categorical \\
      \midrule
      ZIP code       & A 5-digit number      & Labels a place, not an amount \\
      Jersey number  & A number on a uniform & Identifies a player \\
      Student ID     & A numeric code        & A unique tag for one person \\
      Area code      & A 3-digit number      & Labels a calling region \\
      Likert rating  & Looks like a scale    & Spacing between levels not equal \\
    \end{tabular}

    \vspace{0.4em}
    \footnotesize\color{slate}
    \textit{The same \textbf{question} can yield different variable types.
    ``Rate the cafeteria'' can be recorded as a 1--5 scale \textbf{or} as
...
\begin{frame}[t, plain]
  ...
  \begin{minipage}{0.93\textwidth}
    ...
    \begin{tabular}{@{} c >{\raggedright\arraybackslash}p{0.36\textwidth}
                        >{\centering\arraybackslash}p{0.08\textwidth}
                        p{0.37\textwidth} @{}}
      \rowcolor{sky}
      \# & Variable & Type & Reason \\
      \midrule
      1 & Eye color                        & C   & Labels a category \\
      2 & Number of siblings               & QD  & Countable whole numbers \\
      3 & Body temperature (\textdegree F) & QC  & Measured; any decimal \\
      4 & Area code                        & C   & A label, not an amount \\
      5 & Number of words in an essay      & QD  & A count of whole words \\
      6 & Time to run a mile (min)         & QC  & Measured; any positive value \\
      7 & Blood type (A, B, AB, O)         & C   & Sorts into categories \\
      8 & Annual salary (\$)               & QC  & Measured amount \\
    \end{tabular}
  \end{minipage}
\end{frame}
}
...
\begin{frame}[t, plain]
  ...
  \begin{minipage}{0.9\textwidth}
    ...
    \begin{tabular}{@{} >{\bfseries\leavevmode\color{navy}}p{0.12\textwidth}
                        p{0.80\textwidth} @{}}
...
\begin{frame}[t, plain]
  ...
  \begin{minipage}{0.9\textwidth}
    ...
    \begin{enumerate}
      ...
      \item Sort the variable cards into three columns on the worksheet:\\[6pt]
        \begin{tabular}{@{}l@{\hspace{0.7cm}}l@{\hspace{0.7cm}}l@{}}
          \textbf{\color{greenacc}Categorical} &
          \textbf{\color{navy}Quantitative Discrete} &

...
% and no reflection box: the recycling audit lives only in the AP Practice page.
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Counts \& Shares}
  \vspace{2pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Counts \& Shares $\cdot$ problem 4}
  \vspace{10pt}
  \begin{center}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, About Half $\cdot$ the plurality trap, problem 6}
  \vspace{8pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Bar Graphs $\cdot$ height = count, or height = proportion}
  \vspace{2pt}
  \begin{columns}[t]
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Wins First $\cdot$ the crux, problem 16}
  \vspace{4pt}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel{notes, Wins First $\cdot$ the counterweight, problem 18}
  \vspace{10pt}
  \begin{columns}[t]
    \begin{column}{0.46\textwidth}
...
\begin{frame}[t, plain]
  ...
  \sectionlabel[goldacc]{We do $\cdot$ problems 20--25 $\cdot$ you hold the pen}
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{7pt}
    ...
    \item Two hospitals: 340 of 8{,}500 against 60 of 1{,}000.
    \item The same club data drawn twice --- as counts, then as proportions.
  \end{itemize}
  \begin{block}{Silent and alone --- I am circulating}
    \emph{Item 2} is the one I am reading over your shoulder. If you answered it with the
    counts alone, flag me before you leave.
  \end{block}
\end{frame}

...
% ── vocabpar ────────────────────────────────────────────────────────────────
% \termblanklong opens with \noindent (a no-op mid-paragraph) and closes with
% \\ rather than \par, so chained terms share one paragraph and labels collide
% with the preceding answer. Give each term its own paragraph on both ends.
% Mirrored by \vocabans in notes_key/main.tex.
\newcommand{\vocabterm}[1]{%
  \par\noindent\textbf{\textcolor{navy}{#1:}}\\[1pt]%
  \writeline\\[1pt]\writeline\par\vspace{3pt}}
...
\small
\vocabterm{Variable}
\vocabterm{Categorical variable}
\vocabterm{Quantitative variable}
\vocabterm{Discrete quantitative variable}
\vocabterm{Continuous quantitative variable}
\vocabterm{Distribution of a variable}
\end{vocabbox}
...
\textcolor{white}{Can I list all possible values?} & \blank{2cm} & \blank{2cm} \\
\textcolor{white}{Is it measured on a scale?}      & \blank{2cm} & \blank{2cm} \\
\textcolor{white}{Are there gaps between values?}  & \blank{2cm} & \blank{2cm} \\
\end{tabularx}
\end{notesbox}

...
\begin{tabular}{@{} l c c @{}}
 & a \labelbox{1.7cm}{} & a \labelbox{1.7cm}{} \\[3pt]
\rowcolor{sky}
...
\begin{probgrid}{|Y|Y|}
\pcell{2}{What do the four counts add to, and why must they?}{1.8cm}{} &
\pcell{3}{Write 80 of 400 as a fraction, a decimal, a percent, and a rate.}{1.8cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{4}{A flyer says ``Most North students take the bus.'' Is that a majority?}{2.2cm}{} &
\pcell{5}{Rewrite ``20\%'' as a sentence an AP reader would accept.}{2.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
% ── ROW 3: bar graphs ────────────────────────────────────────────────────────
\mainidea{Bar graphs} &
...
\end{tikzpicture}\\[6pt]
Each bar is one \labelbox{2.0cm}{} \qquad The vertical axis is the \labelbox{2.0cm}{}
\end{center}
\\
& \notesprompt{Read the graph.}
\begin{probgrid}{|Y|Y|}
\pcell{6}{How tall is the Walk bar, and what share of North is that?}{1.8cm}{} &
\pcell{7}{Relabel the axis 0.45, 0.30, 0.20, 0.05. Which bars change height?}{1.8cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{8}{Why are there gaps between the bars?}{1.8cm}{} &
\pcell{9}{Before reading any bar graph, what is the first question to ask?}{1.8cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{10}{Work both walking rates.}{2.0cm}{} &
\pcell{11}{Which school has more walkers? Which has the higher walking rate?}{2.0cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{12}{So which school ``walks more''? Answer honestly.}{2.2cm}{} &
\pcell{13}{What one change would make the district's chart a fair comparison?}{2.2cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{14}{``How many students in this district walk to school?'' Which number, and why?}{2.2cm}{} &
\pcell{15}{A student divides South's 150 walkers by 1{,}400. What did she compute?}{2.2cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{probgrid}{|Y|Y|}
\pcell{16}{Which shift sold more large drinks?}{2.0cm}{} &
\pcell{17}{Work both large-drink rates. Which shift sells them more often?}{2.0cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{18}{One sentence for the staff newsletter comparing the shifts. Which kind of number
did you use, and why?}{2.6cm}{} &
\pcell{19}{The owner asks, ``Which shift is \emph{busier}?'' Which column answers that --- a
rate or a count?}{2.6cm}{} \\ \hline
\end{probgrid}
\\ \hline
\end{guidednotes}

...
together}, \textbf{you do the rest on your own}. The notes give you the two tables, the bar
graph, and the rule for comparing groups of different sizes; the last practice set is where you
run that rule by yourself. \textbf{Two questions in this packet have two defensible answers}

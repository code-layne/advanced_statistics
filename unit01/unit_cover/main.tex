...
\begin{tabularx}{\linewidth}{@{} c >{\bfseries}p{0.38\linewidth} X @{}}
  ...
  \hline
  1.0 & Introducing Statistics: What Can We Learn from Data?
    & Statistical questions, individuals, variables, and the data cycle. \\
  \hline
  ...
  1.2 & Representing a Categorical Variable
    & Frequency and relative frequency tables; bar graphs, segmented bar graphs,
      pie charts. \\
  \hline
  1.3 & Representing a Quantitative Variable with Graphs
  ...
  \hline
  1.5 & Summary Statistics for a Quantitative Variable
    & Mean, median, range, IQR, standard deviation; resistance to outliers. \\
  \hline
  1.6 & Boxplots and Comparing Distributions
    & Modified boxplots and the 1.5 × IQR rule; parallel boxplots; comparing
      shape, center, and spread. \\
  \hline
  1.7 & The Normal Distribution and z-Scores

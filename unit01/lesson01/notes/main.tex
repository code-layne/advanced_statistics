...
% ── vocabpar ────────────────────────────────────────────────────────────────
% \termblanklong opens with \noindent, which is a no-op mid-paragraph, and it
% closes with \\ rather than \par — so chained terms share one paragraph and
% the labels collide with the preceding answer. Give each term its own
% paragraph on both ends. Mirrored by \vocabans in notes_key/main.tex.
...
\vocabterm{Population}
\vocabterm{Sample}
\vocabterm{Census}
\vocabterm{Variability / Variation}
\vocabterm{Data}
\vocabterm{Anecdotal evidence}
\end{vocabbox}

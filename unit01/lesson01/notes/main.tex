...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[anchor=north] at (3.95,-1.0) {\labelbox{2.6cm}{}};
  \node[anchor=north] at (7.4,-1.0) {\labelbox{2.6cm}{}};
...
\begin{probgrid}{|Y|Y|}
\pcell{1}{Group size (number of hikers)}{1.8cm}{} &
\pcell{2}{Dog along (Yes / No)}{1.8cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{3}{Pack weight (pounds)}{1.8cm}{} &
\pcell{4}{Weather at the trailhead}{1.8cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[font=\small] at (1.6,-0.45) {Permit \# is \labelbox{2.2cm}{}};
  % ── bottles ──
  ...
  \node[font=\small] at (7.2,-0.45) {Water bottles is \labelbox{2.2cm}{}};
\end{tikzpicture}
\end{center}
...
\begin{probgrid}{|Y|Y|}
\pcell{5}{Four water bottles --- what real thing is that?}{2.0cm}{} &
\pcell{6}{Hand me the party whose permit is 4179.5.}{2.0cm}{} \\ \hline
\end{probgrid}
\\ \hline
...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[font=\small] at (4.0,-1.85) {The new column is \labelbox{2.6cm}{}};
\end{tikzpicture}
\end{center}
\\
& \notesprompt{Use the two columns.}
\begin{probgrid}{|Y|Y|}
\pcell{7}{Which column can be averaged? Compute it.}{2.0cm}{} &
\pcell{8}{Boone now reads \emph{Medium}. Can the ranger get 140 back? Why?}{2.0cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{9}{Name one thing the ranger can no longer compute.}{2.0cm}{} &
...
--- so is it quantitative? How much more?}{2.2cm}{} &
\pcell{13}{Parking spots 04 and 17. Average them, then hand me the party whose spot that is.
Which kind is \emph{Parking spot}?}{2.2cm}{} \\ \hline
\end{probgrid}
\\
& \begin{probgrid}*{|Y|Y|}
\pcell{14}{\emph{Dog along} is all Yes or No. Where did the 62 come from --- is it a value of
the variable?}{2.2cm}{} &
\pcell{15}{State the amount test in one sentence, without the word \emph{digits}.}{2.2cm}{} \\ \hline
\end{probgrid}
\\ \hline

...
2 & Guided Notes \& Practice & The two kinds of variable, the amount test, and the columns
                 ...
                 the rest, then \emph{The Trailhead Register} and the debrief we fill in
...
\begin{remindbox}
\small
Today runs in three moves, all inside the guided notes: \textbf{I show you}, \textbf{we do one
together}, \textbf{you do the rest on your own}. The notes give you the two kinds of variable
and the test that separates them; \emph{The Trailhead Register} at the end is where you use it.
\textbf{Some of the columns are traps} --- trust what a column \emph{records}, not what it
looks like.
\end{remindbox}

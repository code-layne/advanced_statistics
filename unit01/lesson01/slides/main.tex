...
\begin{frame}[t, plain]
  ...
  \textbf{locker number}.
  \begin{itemize}\setlength{\itemsep}{5pt}
    \item \textbf{16.} Who are the individuals? Label all five: C or Q.
    \item \textbf{17.} Miles traveled and locker number are both digits. Say the difference.
    \item \textbf{18.} Age in years becomes \emph{age group}. Which kind now --- and what did
          we lose?
    \item \textbf{19.} ``The average pass number is 5{,}120.'' Why does that tell us nothing?
  \end{itemize}

...
% debrief frames (formalize in "red ink") → QuickNotes arc → application → homework
% (started in class) → AP Practice. Everything before the debrief divider stays vocabulary-free: the words

...
% This is the lesson's SCORED practice and the LAST component in the packet, started in the
% closing minutes of the period and finished at home. 12pt, like every student component.
% Paper homework is the DEFAULT for this course; DeltaMath is an occasional override that
% replaces this page and strikes its score cell on the cover. The AP Practice component that
% precedes it stays assigned-but-unscored.
% THIRD CONTEXT: the notes teach on the two tryouts, the bread, and the clinic; the AP Practice
% page runs on newborn birth weights; these items are on heart rate, two tests, and a bus route
% — recall is not the skill being built.
% DUE DATE: the first class after two study halls — never "due next class."
...
halls. You will start it in the
...
% ── The scored practice — five exercises spanning Topics 1.9 and 1.10 ───────
\boxguard[14]
...
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  ...
  \item Ana scored \textbf{82} on a chemistry test where the class mean was 74 points with a
        ...
        \answerspace{3.6cm}{Ana. She scored 2.0 standard deviations above her chemistry class's
  ...
  \item A school bus route's travel time is approximately normal with $\mu = 32$ minutes and
        ...
        \begin{tikzpicture}[scale=0.8]
          ...
          \node[font=\scriptsize] at (0,-0.87) {Travel time (minutes)};
        \end{tikzpicture}
        \end{center}
        \vspace{2pt}
  ...
  \item \textbf{AP-style multiple choice.} In Race X, finishing times are approximately normal
        ...
        \end{enumerate}
        \answerspace{3.0cm}{(B). Runner P's $z = (18.0 - 21.0)/1.5 = -2.0$ and runner Q's

...
\begin{frame}[t, plain]
  ...
  \vspace{6pt}
  \begin{center}
    {\small\color{slate} Problems 7--12. I work 7; you work the rest. Problem 11 wants the
    direction \emph{and} what it means in a sprint.}
  \end{center}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \vspace{6pt}
  \begin{center}
    {\small\color{slate} Problem 13 first --- 500 loaves: 68.2, 95.2, 99.8. \quad 400
...
\begin{frame}[t, plain]
  ...
  \begin{block}{But the rule is a fact about a shape}
    A skewed or two-peaked record does \textbf{not} hand you 68--95--99.7. Problem 20 is where
    you say why.
  \end{block}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \begin{block}{The question behind the question}
    Problems 25 and 26 ask you to \redink{judge}, not just compute --- and to name one honest

...
% Mirrors ../warmup/main.tex exactly apart from the package swap, the \pageheader second
% argument, and \blank -> \ans. The \begin{work} block in item 3 is BYTE-IDENTICAL to the
% blank's — that is what keeps the two files the same height.

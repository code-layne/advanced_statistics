...
\small
\begin{multicols}{2}
\vocabans{SOCS}{The AP framework for describing quantitative distributions: Shape, Outliers, Center, Spread.}
\vocabans{Shape}{The overall pattern: symmetric, skewed right/left, unimodal, bimodal, uniform.}
\vocabans{Skewed right (positive skew)}{Long tail toward higher values; bulk of data at lower values. Mean $>$ median.}
\vocabans{Skewed left (negative skew)}{Long tail toward lower values; bulk of data at higher values. Mean $<$ median.}
\columnbreak
\vocabans{Symmetric}{Roughly mirror-image about the center; mean $\approx$ median.}
\vocabans{Unimodal / Bimodal / Uniform}{One peak / Two peaks / All bars roughly equal height.}
\vocabans{Outlier}{A value that falls far from the overall pattern; investigate, do not automatically remove.}
\end{multicols}
\end{vocabbox}

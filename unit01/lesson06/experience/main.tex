...
\pageheader{Unit 1, Lesson 1.6}{Experience \& Formalize: Twenty Free Throws}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=4pt]
  ...
  \item Those five cut the picture into four sections. \textbf{Count} the dots in each.
        ...
        \hline
        \textbf{Players} & \blank{1.3cm} & \blank{1.3cm} & \blank{1.3cm} & \blank{1.3cm} \\
        \end{tabularx}
...
\normalsize
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=4pt]
  \item How wide is the middle half of each route's times? \quad Route A: \blank{2.6cm} \quad
        Route B: \blank{2.6cm}
...
\begin{itemize}[leftmargin=1.1em, itemsep=3pt]
  \item \textbf{Five-number summary:} minimum, \blank{1.3cm}, median, \blank{1.3cm}, maximum.
  \item \textbf{Boxplot:} those five drawn to scale. \textbf{Box} $= Q_1$ to $Q_3$, the middle
        \blank{1.2cm}\%; the line inside is the \blank{2.0cm}. \textbf{Whiskers} reach the most
        extreme value that is \blank{1.4cm} an outlier; an outlier gets its own \blank{1.8cm}
        (a \textbf{modified boxplot}).
  \item \textbf{THE RULE:} each section holds \blank{1.2cm}\% of the data. Width shows
        \blank{1.8cm} --- never \blank{1.5cm}.
  \item \textbf{Parallel (side-by-side) boxplots:} one plot per group on a shared \blank{1.6cm}.
  \item \textbf{Comparing:} \blank{1.6cm}, \blank{2.2cm}, unusual features --- with a comparative
        word (\emph{higher than}) and always \blank{2.2cm}.
  \item \textbf{Mean vs.\ median:} symmetric, close; skewed right, mean to the \blank{1.3cm};
        skewed left, to the \blank{1.3cm}.
  \item \textbf{A boxplot cannot show} \blank{1.5cm}, \blank{1.8cm}, or a second \blank{1.4cm}.
\end{itemize}
\end{tcolorbox}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=4pt]
  \item Median: Period 2 \blank{1.7cm} \quad Period 5 \blank{1.7cm} \qquad
        IQR: Period 2 \blank{1.7cm} \quad Period 5 \blank{1.7cm}

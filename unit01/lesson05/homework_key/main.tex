...
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  \item Seven employees at a small office reported their commute times, in minutes:
        ...
        \answerspace{2.4cm}{The median, 16 minutes. The distribution is skewed to the right: six
        ...
        so it still sits inside the group of six.}
  \item Five children reported how many books they read over the summer:
        ...
        \vspace{4pt}
        New mean: \ans{14} \quad New median: \ans{10} \quad New range: \ans{24}

        \vspace{5pt}
        In one or two sentences, say which summaries moved, which did not, and why.
        \answerspace{2.2cm}{The mean moved from 10 to 14 and the range from 4 to 24; the median
        did not move. Mean and range are nonresistant --- both use the changed value itself ---
        while the median depends only on which value is third in order, and that is still 10.}
  ...
  \item A pediatrician's growth chart reports that the \textbf{90th percentile} of birth weight
        ...
        context.
        \answerspace{1.8cm}{About 90\% of newborn girls weigh 3{,}900 grams or less at birth,
  ...
  \item \textbf{AP-style multiple choice.} A company with 40 employees reports that the
        ...
        \end{enumerate}
        \answerspace{2.4cm}{(B). The mean is nonresistant, so a handful of very large salaries
        ...
        the median, not the mean, that has half the employees above it.}
\end{enumerate}
\end{notesbox}

...
\begin{enumerate}[leftmargin=1.5em, itemsep=8pt]
  ...
  \item What is the range of completion times? \ans{$11-5=6$ min}
  ...
  \item Describe the shape of this distribution. Is it symmetric, skewed left,
        ...
        \ansline{Approximately symmetric: the peak sits at 7 and 8 minutes (5 each),}\\[1pt]
        \ansline{with 3 on each side (6 and 9) and 1--2 at the extremes.}

  \item What percentage of students took longer than 9 minutes to finish?
        Show your calculation.\\[6pt]
        \ansline{$2+1 = 3$ students; $3/20 = 0.15 = \textbf{15\%}$.}
  ...
  \item Write 2--3 complete sentences describing the distribution of completion
        ...
        \ansline{Completion times for these 20 students are approximately symmetric,}\\[1pt]
        \ansline{centred on 7--8 minutes (the two most common times, 5 students each).}\\[1pt]
        \ansline{Times run from 5 to 11 minutes, a spread of 6 minutes.}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=8pt]
  ...
  \item What is the median temperature? Show how you used the stemplot to find it.\\[6pt]
        \ansline{$n=15$, so the median is the 8th leaf counted in order from the top.}\\[1pt]
        \ansline{That is \textbf{68$^\circ$F}.}
  ...
  \item Describe the shape of the distribution. Does it appear skewed or symmetric?
        ...
        \ansline{Roughly symmetric, very slightly skewed right --- most days sit in the}\\[1pt]
        \ansline{60s--70s with one 82$^\circ$F day. October was mild with occasional warm days.}

  \item What is the interquartile range (IQR)? (Hint: find Q1 and Q3 first.)
        Show your work.\\[6pt]
        \ansline{Lower half (positions 1--7): $Q_1 = $ 4th value $= 61^\circ$F.}\\[1pt]
        \ansline{Upper half (positions 9--15): $Q_3 = $ 12th value $= 74^\circ$F. IQR $= \mathbf{13}^\circ$F.}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=10pt]
  ...
  \item Which bin contains the most students? What percentage of students
        ...
        \ansline{$[20,30)$ with 14 students --- 35\% of the class.}

  \item What percentage of students spent at least 30 minutes on homework?
        Show your work.\\[6pt]
        \ansline{$(11+5)/40 = 16/40 = 0.40 = \textbf{40\%}$.}
  ...
  \item Write a complete AP-style description of the distribution of homework
        ...
        \ansline{Homework time for these 40 students is unimodal and skewed right,}\\[1pt]
        \ansline{peaking in the 20--30 minute bin (35\%). A typical student spent}\\[1pt]
        \ansline{20--30 minutes; times span under 10 to nearly 50 minutes.}

  \item A classmate says: ``A stemplot would have been a better choice for this
        data.'' Do you agree? Justify your answer.\\[6pt]
        \ansline{No --- with $n=40$ spanning 0--50 minutes, the stems would carry too}\\[1pt]
        \ansline{many leaves. A histogram shows the shape more clearly at this size.}

...
\begin{frame}[t, plain]
  ...
  19 \; 19.
  \begin{itemize}\setlength{\itemsep}{5pt}
    \item \textbf{13--14.} Fill the five-number summary: minimum, $Q_1$, median, $Q_3$, maximum;
          then the mean.
    \item \textbf{15.} The range and the IQR --- one number each.
    \item \textbf{16--17.} Then the lowest score turns out to be a \textbf{1}, not a 12. Which of
          \emph{mean, median, range, IQR} move? Is the 1 an outlier --- and which pair would
          you report now?
  \end{itemize}

...
\begin{enumerate}[leftmargin=1.9em, itemsep=0.40in]
  ...
  \item \textbf{From last lesson.} Twelve students reported how many hours of television they
        ...
        from the rest.\\[14pt]
        \ansline{Skewed to the right: most students watched 1--6 hours and the tail runs to}\\[14pt]\ansline{the high end. The student who watched 14 hours stands well apart from the rest.}

  \item Here are six numbers: \quad 4 \quad 9 \quad 6 \quad 12 \quad 7 \quad 10

        \vspace{12pt}
        Their \textbf{average}: \ans{$48 \div 6 = 8$}

        \vspace{12pt}
        Put them in order and give the value in the \textbf{middle}: \ans{8 (halfway between 7 and 9)}

...
\pageheader{Unit 1, Lesson 1.5}{Experience \& Formalize: Nine Paychecks}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=4pt]
  \item Find the \textbf{average} of the nine paychecks. \blank{2.6cm}

        Now put the nine in order and give the value in the \textbf{middle}. \blank{2.6cm}
...
\begin{enumerate}[label=\textbf{\alph*.}, leftmargin=1.8em, itemsep=4pt]
  \item \textbf{Each route's twelve times add to 360 minutes.} With twelve values none sits
        ...
        \vspace{3pt}
        Route A --- average: \blank{1.7cm} \quad middle: \blank{1.7cm}

        Route B --- average: \blank{1.7cm} \quad middle: \blank{1.7cm}

        \vspace{3pt}
        Do the two routes have the same centre? \blank{2.2cm}
...
\begin{itemize}[leftmargin=1.1em, itemsep=3pt]
  \item A \textbf{statistic} is a numerical summary of \blank{2.4cm} data.
        \textbf{Mean} ($\bar x$): add every value and divide by \blank{4.4cm}.
        \textbf{Median}: the \blank{1.7cm} value of the \emph{ordered} data --- with an even
        count, the \blank{2.0cm} of the two middle values.
  \item The \textbf{$p$th percentile} is the value with $p\%$ of the data \blank{4.6cm} it.
        \textbf{$Q_1$} and \textbf{$Q_3$} are the medians of the lower and upper halves;
        between them sits the middle \blank{1.2cm}\% of the data.
  \item \textbf{Range} $=$ \blank{2.2cm} $-$ \blank{2.2cm}. \quad
        \textbf{IQR} $=$ \blank{1.3cm} $-$ \blank{1.3cm}. \quad Each is \emph{one number}, not
        an interval.
  \item \textbf{Standard deviation} ($s_x$): roughly the \blank{2.2cm} distance of a value from
        the mean. We get it from \blank{2.4cm}; its square $s_x^2$ is the \blank{2.2cm}.
        \[ s_x \;=\; \sqrt{\frac{1}{n-\blank{0.7cm}}\sum_{i=1}^{n}\left(x_i-\bar x\right)^2} \]
  \item \textbf{Resistant} (one extreme value barely moves it): \blank{2.0cm} and
        \blank{1.4cm}. \quad \textbf{Nonresistant} (one extreme value drags it):
        \blank{1.6cm}, \blank{4.0cm}, and \blank{1.6cm}.
  \item \textbf{Two outlier rules in this course:} more than $1.5\times\text{IQR}$ above $Q_3$
        ...
        $1.5\times\text{IQR}$ rule goes to work \blank{2.0cm} lesson.
\end{itemize}
\end{tcolorbox}

...
\begin{multicols}{2}
\vocabterm{Dotplot}
\vocabterm{Stemplot (stem-and-leaf plot)}
\columnbreak
\vocabterm{Histogram}
\vocabterm{Bin (class interval)}
\vocabterm{Gap / Cluster}
\end{multicols}
\end{vocabbox}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=8pt]
  ...
  \item Test scores (out of 100) for two Statistics classes of 25 students each.\\
        Display: \blank{2.5cm} \quad Reason: \blank{7cm}
\end{enumerate}
\end{practicebox}

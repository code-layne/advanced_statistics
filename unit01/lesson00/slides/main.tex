...
\begin{frame}[t, plain]
  ...
  \sectionlabel[goldacc]{AP-style practice --- this one \emph{is} scored}
  \begin{itemize}\setlength{\itemsep}{5pt}
  ...
  \end{itemize}
  \begin{block}{How it is scored}
    The way the AP exam scores it: \redink{in context, or it does not count.} Naming a
    question is half an answer --- say what \emph{varies}. Due at the start of next class.
  \end{block}
\end{frame}

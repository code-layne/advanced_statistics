...
% Mirrors the blank homework exactly: same boxes, same \boxguard values, same item text.
...
\begin{extensionbox}
\small
Find a number reported in a news headline this week. Write down the headline, then list every
piece of context it leaves out. Finish by writing the statistical question the study behind it
must have asked.\\[4pt]
\ansline{Answers vary. Look for: who was measured, what was measured, in what units,}
\ansline{when/where, and a question whose answer differs across individuals.}
\end{extensionbox}
...
\begin{spiralbox}
\small
\textbf{Next lesson: The Language of Variation.} You have now seen that a variable is a column
...
\emph{amount} --- and see why the difference decides everything we are allowed to do with them.
\end{spiralbox}

...
items~2 and~4 are the early-finisher bank. The graded practice is the DeltaMath homework, below.
\end{skillbox}
...
\textbf{Point students to DeltaMath} for the graded homework (due next class) and remind them
the AP Practice page in the packet is theirs to work and bring to review, then close on what
changed rather than on the assignment: \emph{``This morning seven numbers meant nothing to you. You now know exactly what
...
assignment. Work it as AP-format reps and go over it at the start of Lesson~1.1.

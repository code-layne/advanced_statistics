...
\begin{skillbox}[Hook]{sky}
    ...
    Present: a random sample of 200 female students found 120 plan to take Chemistry.
...
\begin{skillbox}[Lesson]{sky}
    \begin{enumerate}[leftmargin=1.4em, label=\arabic*.]
        ...
        \item \textbf{Worked example.} Chemistry: $\hat p_1=0.60$, $n_1=200$; $\hat p_2=0.55$, $n_2=180$.
